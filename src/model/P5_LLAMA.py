...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.whole_word_embeddings = nn.Embedding(512, config.hidden_size, self.padding_idx)
    ...
    def forward(
        ...
        whole_word_ids: Optional[torch.Tensor] = None,
...
class P5_LLAMA(LlamaPreTrainedModel):
